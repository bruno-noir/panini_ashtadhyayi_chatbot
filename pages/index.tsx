...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Panini Bot - Login or Signup</title>
      </Head>
      <div className="flex min-h-screen w-full items-center justify-center bg-gray-800 text-center text-white">
        <div className="p-10 rounded-lg shadow-2xl bg-gradient-to-bl from-gray-700 to-gray-800">
          <div>
            <FontAwesomeIcon
              icon={faRobot}
          ...
          <h1 className="text-4xl font-bold">Welcome to Panini Bot</h1>
